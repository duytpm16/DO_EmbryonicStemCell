...
load("~/Desktop/Munger Embryonic Stem Cells/Selcan Corrected IDs/prelim_proteomics_correctedIDs.RData")          # Preliminary pQTL mapping .RData file, by Selcan, /projects/munger-lab/projects/DO_eQTL_comparison/data
load("~/Desktop/Munger Embryonic Stem Cells/Selcan Corrected IDs/do_mesc_corrected_genoprobs_v1.1.RData")        # Created by Duy, swapped genotypes but not sample IDs, /projects/munger-lab/projects/DO_eQTL_comparison/data
