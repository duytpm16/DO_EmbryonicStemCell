...
load("~/Desktop/Munger Embrynic Stem Cells/Proteomics/Selcan Corrected IDs/prelim_proteomics_correctedIDs.RData") # Preliminary pQTL mapping .RData file, by Selcan, /projects/munger-lab/projects/DO_eQTL_comparison/data
load("~/Desktop/Munger Embrynic Stem Cells/Proteomics/Selcan Corrected IDs/do_mesc_corrected_genoprobs_v1.1.RData")              # Created by Duy, swapped genotypes but not sample IDs, /projects/munger-lab/projects/DO_eQTL_comparison/data
load("~/Desktop/Munger Embrynic Stem Cells/Proteomics/Selcan Corrected IDs/Corrected_PBID_SampleMatch_Key.RData")                # Correct matching IDs file by Selcan, /projects/munger-lab/projects/DO_eQTL_comparison/data
...
#   new_raw:  7,853 x 195
new_raw   <- read.delim("~/Desktop/Munger Embrynic Stem Cells/Proteomics/Original Data/DO_mESC_protein_quant_new.tsv")
