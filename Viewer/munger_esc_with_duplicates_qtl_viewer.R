...
### Taking from Selcan Aydins in Steve Munger lab
load("~/Downloads/DO_mESC_paired_eQTL_forMapping.RData")
mrna_samples <- covarTidy
mrna_raw     <- esc.raw.expr
...
stopifnot(mrna_rankz == esc.exprZ[, annots$gene.id])
...
save.image(file = '~/Desktop/Munger Embryonic Stem Cells/RNA/Version 1 - With Duplicates/munger_esc_mrna_qtl_viewer_v1.RData')
